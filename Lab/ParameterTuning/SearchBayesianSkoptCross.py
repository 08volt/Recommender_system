...
from ParameterTuning.SearchAbstractClassCross import SearchAbstractClassCross
import traceback


class SearchBayesianSkoptCross(SearchAbstractClassCross):

    ALGORITHM_NAME = "SearchBayesianSkoptCross"

    def __init__(self, recommender_class,n_validations, evaluator_validation = None, evaluator_test = None, verbose = True):


        super(SearchBayesianSkoptCross, self).__init__(recommender_class,n_validations,
