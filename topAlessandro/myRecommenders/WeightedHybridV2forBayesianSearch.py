...
def createWeights(w0,w1,w2,w3,w4,w5,w6):
    ...
    return weights
#-----------------------
class WeightedHybridV2forBayesianSearch(BaseRecommender):
    RECOMMENDER_NAME = "WeightedHybridV2forBayesianSearch"
    ...
    def __init__(self, URM_train,ICM_all):
        ...
        super(WeightedHybridV2forBayesianSearch, self).__init__(URM_train)
