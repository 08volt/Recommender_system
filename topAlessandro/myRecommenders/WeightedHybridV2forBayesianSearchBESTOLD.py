...
def createWeights(w0,w1,w2,w3,w4,w5):
    ...
    return weights
#-----------------------
class WeightedHybridV2forBayesianSearchBESTOLD(BaseRecommender):
    RECOMMENDER_NAME = "WeightedHybridV2forBayesianSearchBESTOLD"
    ...
    def __init__(self, URM_train,ICM_all):
        ...
        super(WeightedHybridV2forBayesianSearchBESTOLD, self).__init__(URM_train)
